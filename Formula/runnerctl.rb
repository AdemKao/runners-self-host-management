class Runnerctl < Formula
  ...
  test do
    assert_equal "0.7.3", shell_output("#{bin}/runnerctl version").strip
    ...
    assert_match '"current_version":"0.7.3"', shell_output("RUNNERCTL_LATEST_VERSION=0.7.3 RUNNERCTL_INSTALL_METHOD=homebrew #{bin}/runnerctl upgrade --check --json")
  end
end
